...
class ExportFileUseCase extends BaseUseCase<void, BackupParams> {
  final ReportsRepository _reportsRepository;

  ExportFileUseCase(this._reportsRepository);

  @override
  Future<Either<Failure, void>> call(BackupParams params) async {
    return await _reportsRepository.exportToFile(params);
  }
}
