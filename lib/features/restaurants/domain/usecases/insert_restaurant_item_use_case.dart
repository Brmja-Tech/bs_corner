...
class InsertRestaurantItemUseCase extends BaseUseCase<String, InsertItemWithRecipesParams> {
  final RestaurantsRepository _restaurantRepository;

  InsertRestaurantItemUseCase(this._restaurantRepository);

  @override
  Future<Either<Failure, String>> call(InsertItemWithRecipesParams params) {
